...
module.exports.getSummonerData = function getSummonerData(summonerName, region, cb) {
  ...
  riotRequest(riotRequest.getPlatformFromRegion(region), endpoint, duration.A_DAY, function(err, data) {
    if(err) {
...
module.exports.getCurrentRank = function getCurrentRank(summonerId, region, cb) {
  var endpoint = '/lol/league/v3/positions/by-summoner/' + summonerId;
