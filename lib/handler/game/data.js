...
var gameData = require('../../helper/game-data-v3/');
var summonerInfo = require('../../riot-api/summoner-info-v3');
var gameInfo = require('../../riot-api/game-info-v3');
  ...
  async.waterfall([
    function getSummonerId(cb) {
      summonerInfo.getSummonerData(summonerName, summonerRegion, function(err, summonerData) {
        if(!err && (!summonerData || !summonerData.id)) {
    ...
    function sortPlayers(gameData, cb) {
      gameData.teams.forEach(function(team) {
