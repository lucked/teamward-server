...
module.exports.get = function(req, res) {
  ...
  if(!availableRoles.has(req.query.role)) {
  ...
  async.auto({
    ...
    loadSummonerData: function loadSummonerData(cb) {
      summonerInfo.getSummonerData(req.query.summoner, req.query.region, cb);
    },
    ...
    computeCounters: ["loadRoleChampions", "loadChampionMasteries", function(cb, res) {
      ...
      computeCounters(res.loadRoleChampions, masteredChampions);
    }]
  },
