...
GameSchema.statics.fromAPI = function fromAPI(apiGame, summonerId, region) {
  ...
  game.type = apiGame.gameType;
  game.subType = apiGame.subType;
  game.map = apiGame.mapId;
  game.time = apiGame.stats.timePlayed;
  game.winner = apiGame.stats.win ? apiGame.teamId : (apiGame.teamId === 100 ? 200 : 100);
