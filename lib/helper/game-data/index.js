...
var queueRankedForDownload = require('./queue-ranked-for-download.js');
...
var computeAllGameData = function computeAllGameData(gameInfo, region, cb) {
  ...
  async.auto({
    ...
    queueRankedForDownload: ['rawMatchHistoryData', function(res, cb) {
      queueRankedForDownload(res.rawMatchHistoryData, region, cb);
    }],
