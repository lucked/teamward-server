...
module.exports.getDetailedChampionData = function(locale, championId, cb) {
  async.waterfall([
    ...
    function downloadSpecificData(ddragonData, cb) {
      var endpoint = '/api/lol/static-data/EUW/v1.2/champion?champData=enemytips,passive,spells&locale=' + locale;

      riotRequest('global', endpoint, duration.A_DAY, rarity.carry([ddragonData.id], cb));
    },
